...
import com.ouchn.flipper.Animations.BaseAnimationInterface;
import com.ouchn.flipper.Indicators.PagerIndicator;
import com.ouchn.flipper.SliderTypes.BaseSliderView;
import com.ouchn.flipper.Transformers.AccordionTransformer;
import com.ouchn.flipper.Transformers.BackgroundToForegroundTransformer;
import com.ouchn.flipper.Transformers.BaseTransformer;
import com.ouchn.flipper.Transformers.CubeInTransformer;
import com.ouchn.flipper.Transformers.DefaultTransformer;
import com.ouchn.flipper.Transformers.DepthPageTransformer;
import com.ouchn.flipper.Transformers.FadeTransformer;
import com.ouchn.flipper.Transformers.FlipHorizontalTransformer;
import com.ouchn.flipper.Transformers.FlipPageViewTransformer;
import com.ouchn.flipper.Transformers.ForegroundToBackgroundTransformer;
import com.ouchn.flipper.Transformers.RotateDownTransformer;
import com.ouchn.flipper.Transformers.RotateUpTransformer;
import com.ouchn.flipper.Transformers.StackTransformer;
import com.ouchn.flipper.Transformers.TabletTransformer;
import com.ouchn.flipper.Transformers.ZoomInTransformer;
import com.ouchn.flipper.Transformers.ZoomOutSlideTransformer;
import com.ouchn.flipper.Transformers.ZoomOutTransformer;
import com.ouchn.flipper.Tricks.FixedSpeedScroller;
import com.ouchn.flipper.Tricks.InfinitePagerAdapter;
import com.ouchn.flipper.Tricks.InfiniteViewPager;
import com.ouchn.flipper.Tricks.ViewPagerEx;
...
//        if (isInEditMode()) { return; }
        ...
        mViewPager = (InfiniteViewPager)findViewById(R.id.infiniteViewPager_id);
