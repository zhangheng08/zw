 ...
 * @author wz
 */
public class CMSListFragment extends BaseFragment {

	public static final String TAG = CMSListFragment.class.getName();
	...
	private static CMSListFragment self = new CMSListFragment();
	public CMSListFragment() {}

	public static CMSListFragment getInstance() {
		return self;
	}
	...
	private void refreshCourseCenter() {
		...
		final JsonObjectRequest jsonRequest = new JsonObjectRequest(StaticConfigs.URL_CMS_LIST, null,
